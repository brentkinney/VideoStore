public class DLLTester {    
	public static void main(String[] args) {
		...
		//d.removeAtIndex(1);
		d.print();
		System.out.println("A Prev: " + a.getPrev());
		System.out.println("A Next: " + a.getNext().getElement());
		...
		System.out.println("E Prev: " + e.getPrev().getElement());
		System.out.println("E Next: " + e.getNext());
